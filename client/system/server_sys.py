...
model_dict = {
    ...
    "efficientnet-bright": "model/cats_efficientnetb0-Noise-Brightness-V3-bright-05.keras",
    "efficientnet-dark": "model/cats_efficientnetb0-Noise-Brightness-V3-dark-05.keras"
}
